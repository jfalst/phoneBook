...
<div class="container">
  ...
  <form action="updateContact.php" method="post">
    ...
    <div class="form-group">
      ...
      <input value="<?php if(isset($last)) echo $last ?> " type="text" class="form-control" name="lname">
    </div>
    <div class="form-group">
      <label for="firstname">First Name:</label>
      <input value="<?php if(isset($first)) echo $first ?> "type="text" class="form-control" name="fname">
    </div>
    <div class="form-group">
      <label for="phone">Phone:</label>
      <input value="<?php if(isset($phone)) echo $phone ?> " type="text" class="form-control" name="pname">
    </div>
    <div class="form-group">
      <label for="email">Email:</label>
      <input value="<?php if(isset($mail)) echo $mail ?> "type="text" class="form-control"  name="email">
